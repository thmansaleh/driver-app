...
if(data){
    ...
    return (
        <div key='media-tab'>
            ...
            <input className="hidden tabs" type="radio" id='vehicles-tab' name="tabs" />
            <label htmlFor='vehicles-tab' >
                <div onClick={e => {
                    dispatch(setTab('vehicles'))
            ...
            <div className="text-sm font-semibold text-gray-800">المركبات</div>
                </div>
